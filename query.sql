...
-- Patient
create table Patient(P_ID varchar(50),Name varchar(50),DOB varchar(50),Gender varchar(50),Blood_Group varchar(50),Email varchar(50),Address varchar(50),Mobile varchar(20),foreign key(Email) references UserReg(Email));

-- Bill
create table Bill(P_ID VARCHAR(50),BillNo INT PRIMARY KEY AUTO_INCREMENT,Date DATE,Time TIME,Status VARCHAR(50),Amount VARCHAR(50));
